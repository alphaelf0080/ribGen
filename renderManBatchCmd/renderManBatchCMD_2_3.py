...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_createBatchCmd.setGeometry(QtCore.QRect(30, 270, 131, 23))
        ...
        self.lineEdit_filePath_renderCmd.setGeometry(QtCore.QRect(180, 270, 491, 20))
        ...
        self.pushButton_genRenderJob.setGeometry(QtCore.QRect(30, 420, 131, 23))
        self.pushButton_genRenderJob.setObjectName("pushButton_genRenderJob")
        self.label_4 = QtGui.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(40, 330, 91, 16))
        self.label_4.setObjectName("label_4")
        self.lineEdit_fileNamePrefix = QtGui.QLineEdit(self.centralwidget)
        self.lineEdit_fileNamePrefix.setGeometry(QtCore.QRect(140, 330, 531, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_filePath_renderCmd.setText(QtGui.QApplication.translate("MainWindow", "", None, QtGui.QApplication.UnicodeUTF8))
...
#-------------------lineText-------------------------        
    ...
    def modpushButton_createBatchCmd(self):
        ...
        jsonFileName = self.cmdFileLocation +"/"+ self.lineEdit_filePath_renderCmd.text()[0:-3]+"json"
        print jsonFileName
    ...
    def createRenderCmdJson(self):
       ...
       # print self.batchRenderCmdLis
        ...
        json.dumps(self.batchRenderCmdLis, sort_keys=True , indent =4)  #編譯成json 且賦予格式 控四格
